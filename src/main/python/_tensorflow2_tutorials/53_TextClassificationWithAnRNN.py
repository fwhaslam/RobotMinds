...
#
#   Sentiment Analysis of IMDB Review database.  Each review is either positive or negative.
#
#   This code is identical to what is presented on the tutorial page except for:
#       header comments
#       some code exits transformed to 'print' statements
#
#   Code tested with:

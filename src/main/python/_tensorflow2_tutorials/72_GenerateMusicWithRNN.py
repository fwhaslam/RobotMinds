...
# INSTALLS:
# download and install fluidsynth
#   https://github.com/FluidSynth/fluidsynth/wiki/Download
#   choco install fluidsynth ( in windows using chocolatey )
...
print('raw_notes.head() =',raw_notes.head())


get_note_names = np.vectorize(pretty_midi.note_number_to_name)
sample_note_names = get_note_names(raw_notes['pitch'])
print('first ten sample_note_names =',sample_note_names[:10])
...
print('notes_ds.element_spec =',notes_ds.element_spec)
...
print('seq_ds.element_spec =',seq_ds.element_spec)

#
#   Source:
#       Machine Learning Master article by Mehreen Saeed ( https://machinelearningmastery.com/author/msaeed/ )
#       https://machinelearningmastery.com/adding-a-custom-attention-layer-to-recurrent-neural-network-in-keras/
#
#   Recurrent Neural Network with Attention to learn Fibonacci series
#
...
#
#   Code tested with:
#       Tensorflow 2.11.0 / Tensorflow-gpu 2.10.1 / Cuda 11.7 / CudaNN 8.4 / VC_Redist 2019+
#
